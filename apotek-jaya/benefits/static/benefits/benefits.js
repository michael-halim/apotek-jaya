		...
		$.ajax({
			...
			success: function (result) {
				if (result.success === true) {
                    ...
                    $('input#value').val('Rp. ' + format_number(value));
                    
                    if (!result.is_view_only) {
                        $('select#benefit_category').removeClass('form-control');
                        dselect(document.querySelector('select#benefit_category'), {
                            search: true,
                            clearable: true,
                        });
                        
                    } else{
                        $('select#benefit_category').addClass('form-control');
                    }
